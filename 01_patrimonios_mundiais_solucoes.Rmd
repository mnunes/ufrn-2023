...
```{r}
mapa_mundi +
  coord_sf(xlim = c(-120, -30), 
           ylim = c(-60, 40)) +
  geom_point(data = filter(unesco, region_en == "Latin America and the Caribbean"), 
...
mapa_mundi +
  ...
  scale_colour_viridis_d() +
  labs(x = "Longitude", y = "Latitude", colour = "Categoria")
```
...
```{r}
mapa_mundi +
  geom_point(data = filter(unesco, danger == 1), 
             aes(x = longitude, y = latitude)) +
  labs(x = "Longitude", y = "Latitude")
```
